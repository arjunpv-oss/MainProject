...
public class EditProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    String path, atype, fname, attach="0", attatch1;
    byte[] byteArray = null;
    ...
    TextInputLayout fnm=(TextInputLayout)findViewById(R.id.fullname);
     ...
     bt1.setOnClickListener(this);
        ...
        String hu = sh.getString("pname", "");
        String hi = sh.getString("age", "");
        String ha = sh.getString("place", "");
        String h = sh.getString("post", "");
        String he = sh.getString("pinn", "");
        String hl = sh.getString("phonee", "");
        String hm = sh.getString("pic", "");
    ...
    public void onClick(View v) {
        ...
        String url = "http://" + hu + ":5000/updatepatiprofile_post";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                Intent ij = new Intent(getApplicationContext(), PatiProfile.class);
                                startActivity(ij);
